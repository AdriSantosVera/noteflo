      ...
      <section className="page-panel">
        <div className="hero-row">
          ...
          <div className="status-stack">
            ...
            <div className="status-badge status-badge-muted">
              Next.js + Neon + Zod
            </div>
          </div>
        </div>
        ...
        <div className="section-grid section-grid-wide">
          <article className="info-card info-card-featured">
            ...
            <p>
              ...
              notas y items de checklist. Esta pantalla sirve como entorno
              visual de validación sin mezclar el backend con la app Expo.
            </p>
          ...
          <article className="info-card">
            ...
            <ul className="list">
              <li>
                <code>/api/notes</code> para listado y creación
              </li>
              <li>
                <code>/api/notes/:id</code> para lectura, edición y borrado
              </li>
              <li>
                <code>/api/checklist-items/:itemId</code> para toggle y delete
              </li>
              <li>
                <code>docs/</code> y <code>sql/</code> como soporte técnico
              </li>
            </ul>
          </article>
            ...
            <div className="code-block">{`POST /api/notes
{
  ...
  "content": "Definir CRUD y esquema SQL"
          ...
          <article className="info-card">
            ...
            <ul className="list">
              <li>
                <code>README.md</code> con setup y endpoints
              </li>
              <li>
                <code>docs/backend-teoria.md</code> con fundamentos
              </li>
              <li>
                <code>docs/seguridad-api.md</code> con seguridad y SQL injection
              </li>
            </ul>
          </article>
        </div>
